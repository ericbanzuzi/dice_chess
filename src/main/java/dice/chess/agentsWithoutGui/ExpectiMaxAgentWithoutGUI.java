...
public class ExpectiMaxAgentWithoutGUI {
    ...
    public ExpectiMaxAgentWithoutGUI(int maxDepth, boolean pruning){
...
//                    String numbersOnly = tempActions.name().replaceAll("[^0-9]", "");
                    qAgent.updateQTable(stateX, stateY, this.whitePiece, this.blackPiece.getPosX(),
                            this.blackPiece.getPosY(), this.blackPiece, bestLastMove, reward, moves);
                }
            }
        } else {
...
//                        String numbersOnly = tempActions.name().replaceAll("[^0-9]", "");
                        qAgent.updateQTable(stateX, stateY, this.whitePiece, blackPiece.getPosX(),
                                blackPiece.getPosY(), blackPiece, bestLastMove, reward, moves);
                    }
                }
