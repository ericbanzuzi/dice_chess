...
public class ExpectiMaxAgent {
    ...
    public ExpectiMaxAgent(int maxDepth, boolean pruning){
        this.maxDepth = maxDepth;
        this.pruning = pruning;
    }
    // method to use for GUI
    public void play(ChessBoardWindow chessBoardWindow, Board board, DrawableDie drawableDie, boolean white, boolean black) {
        new Thread(() ->{
            try {
                Thread.sleep(100);
...
//            System.out.println("initial x " + move.getPiece().getPosX() + " initial y "+ move.getPiece().getPosY());
    ...
    public MoveState expectiMaxPruning(Board board, List<Piece> movablePieces, int depth, boolean maximizing, String maxColor, boolean chanceNode) {
