...
public class ExpectiMaxPruningTest {
    ...
    public void testPawnKing() {
        ExpectiMaxAgent mm = new ExpectiMaxAgent(1,true);
        ...
        MoveState move = mm.modifiedPruning(board,movablePieces,1,true,maxColor, false);
        System.out.println("Move from expectiMax: " + move.toString());
        System.out.println("Expected Ideal move: "+ idealMove);
    ...
    public void testDepth2_1() {
        ...
        ExpectiMaxAgent a = new ExpectiMaxAgent(2,true);
        int[] bestMove = {1, 3};
        MoveState idealMove = new MoveState(new Queen(max, 0, 0), bestMove, -1855.0);
        MoveState move = a.modifiedPruning(board, movablePieces, 2, true, maxColor , false);
    ...
    public void testDepth3() {
        ...
        ExpectiMaxAgent a = new ExpectiMaxAgent(3,true);
        int[] bestMove = {2, 5};
        MoveState idealMove = new MoveState(new Queen(max, 0, 0), bestMove, 20265.0);
        MoveState move = a.modifiedPruning(board, movablePieces, 3, true, maxColor , false);
    ...
    public void testPosition1() {
        ...
        ExpectiMaxAgent mm = new ExpectiMaxAgent(4,true);
        ...
        board.movePiece(board.board[7][6], 5, 5);
        board.movePiece(board.board[0][4], 1, 3);
        board.movePiece(board.board[5][5], 3, 4);
        ...
        MoveState move = mm.modifiedPruning(board,movablePieces,4,true,maxColor,false);
        System.out.println("Move from expectiMax: " + move.toString());
        System.out.println("Expected Ideal move: "+ idealMove);
    ...
    public void testPosition3() {
        ...
        board.movePiece(board.board[0][3], 3, 6);
    ...
    @Test
    public void testPruningTime1() {
        //Test if pruning reduce the time
        ExpectiMaxAgent mm = new ExpectiMaxAgent(4,true);
        ...
        MoveState prunedMove = mm.modifiedPruning(board,movablePieces,4,true,maxColor,false);
        System.out.println(System.currentTimeMillis() - currentTime);
        currentTime = System.currentTimeMillis();
        MoveState emmMove = mm.expectiMax(board,movablePieces,4,true,maxColor,false);
        System.out.println(System.currentTimeMillis() - currentTime);

        boolean val = isEqual(prunedMove, emmMove);
        assertTrue(val);
    }

    @Test
    public void testPruningTime2() {
        //Test if pruning reduce the time
        ExpectiMaxAgent mm = new ExpectiMaxAgent(4,true);
